...
class Drivetrain {
    ...
    void Drive(units::feet_per_second_t xSpeed, units::feet_per_second_t ySpeed, units::degrees_per_second_t rot, bool fieldRelative);
    void UpdateOdometry();

    static constexpr units::feet_per_second_t kMaxSpeed = 3.0_fps;  // 3 feet per second
    static constexpr units::degrees_per_second_t kMaxAngularSpeed{std::numbers::pi};  // 1/2 rotation per second
